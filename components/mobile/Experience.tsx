  ...
  return (
    ...
    >
      <img
          ...
          className="w-full h-[1334px] absolute top-[0px] left-[0px]  z-[0] img-disabled"
          alt=""
        />

      <img
          src="/mobile/experience.png"
          className="w-full h-[78px] absolute top-[0px] -left-[0px]  z-[10] img-disabled"
          alt=""
        />
      ...
      <motion.div
        ...
        className="relative flex flex-col items-center justify-center -mt-[30px] w-[92%]"
      > 
        <div className="text-[36px] leading-[54px] font-[800] w-full mt-[62px] flex flex-col items-center justify-center z-[100] text-black fontPP">
        ...
        <div className="flex flex-col justify-center items-center text-black  !border-b-[1px] !border-b-[#D9D9D9] ">
          <div className="flex flex-col items-center justify-center w-[570px] mt-[40px] gap-[30px] text-[24px] leading-[42px]">
