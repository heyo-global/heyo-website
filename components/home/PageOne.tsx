  ...
  return (
    <div className="w-screen h-screen relative overflow-hidden bg-black">
      ...
      <div className=" relative w-full h-full overflow-hidden">
        ...
        <img src="/Hotspots-03.svg" alt="" className="img-disabled absolute top-[83vw] left-[40vw] z-[300] w-[10vw] h-[16vw] marker2 md:top-[10vw] md:left-[64vw] md:w-[5.1vw] md:h-[8.2vw]"/>
        <img src="/Hotspots-04.svg" alt="" className="img-disabled absolute top-[92vw] left-[56vw] z-[300] w-[10vw] h-[16vw] marker3 md:top-[16vw] md:left-[68vw] md:w-[5.1vw] md:h-[8.2vw]"/>
        <img src="/Hotspots-06.svg" alt="" className="img-disabled absolute top-[82vw] left-[66vw] z-[300] w-[10vw] h-[16vw] marker4 md:top-[20vw] md:left-[76vw] md:w-[5.1vw] md:h-[8.2vw]"/>
        ...
        <img src="/Hotspots-01.svg" alt="" className="img-disabled absolute top-[112vw] left-[68vw] z-[300] w-[10vw] h-[16vw] marker6 md:top-[32vw] md:left-[68vw] md:w-[5.1vw] md:h-[8.2vw]"/>
      </div>
