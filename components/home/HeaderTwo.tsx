    ...
    <div className="md:h-[6.8vw] h-[11.5vw] absolute left-0 right-0 top-0 z-[100] text-xs flex items-center justify-between bg-transparent backdrop-blur  px-[4.3vw] md:px-[1.88vw]">
      ...
      <div className="flex flex-row-reverse items-center gap-4 md:gap-6">
        <Link
          ...
          rel="noreferrer"
        >
          <Image src="/icon-x-black.svg" alt="X" className="w-[3.2vw] h-[3.2vw] md:w-[1.8vw] md:h-[1.8vw] img-disabled" />
        </Link>
        <Link
          ...
          rel="noreferrer"
        >
          <Image src="/icon-t-black.svg" alt="T" className="w-[3.4vw] h-[3.4vw] md:w-[2vw] md:h-[2vw] img-disabled" />
        </Link>
      </div>
    </div>
  );
