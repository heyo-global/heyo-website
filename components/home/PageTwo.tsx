  ...
  return (
    <div className="w-full h-screen overflow-hidden relative flex justify-center items-center md:flex-row flex-col bg-theme-color">
      ...
      <img
        ...
        className="w-full h-[19.3vw] hidden md:block  absolute bottom-0 left-0 z-[2] img-disabled"
        alt=""
      />

      <img
        src="/image-footer-phone.png"
        className="w-full h-[32.27vw] md:hidden block absolute bottom-0 left-0 z-[2] img-disabled"
        alt=""
      />
