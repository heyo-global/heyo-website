...
const RealWord = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col md:flex-row justify-between items-center relative mt-[20px] md:mt-[4.2vw] md:w-[57.2vw] h-[830px] md:h-[30.57vw]"
        ref={ref}
      >
        <motion.div
        ...
        >
          ...
          <img
            ...
            alt=""
            className="w-[188px] h-[122px] md:my-[16px] md:w-[10.8vw] md:h-[11.4vw]"
          />
          <span className="text-[12px] leading-[16px] font-[600] md:text-[0.73vw] md:leading-[0.94vw]">
